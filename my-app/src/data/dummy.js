...
const memberGridImage = (props) => (
  <div className="image flex gap-4">
    ...
    <div>
      ...
      <p>{props.MemberEmail}</p>
    </div>
  </div>
);

const memberGridStatus = (props) => (
...
export const fitnessData = [
  ...
  },
  {
    ...
    percentage: '-1%',
    rank: '3rd',
    title: 'Individual Weekly Steps',
    iconColor: 'rgb(227, 175, 18)',
    iconBg: 'rgb(248, 250, 187)',
    pcColor: 'green-600',
  },
  {
    icon: <MdGroups />,
    ...
    percentage: '0%',
    rank: '2nd',
    title: 'Team Weekly Stpes',
    iconColor: 'rgb(12, 117, 48)',
    iconBg: 'rgb(230, 252, 237)',
    pcColor: '#000000',
  },
  {
    icon: <GiRun />,
    ...
    percentage: '+1%',
    rank: '3rd',
    title: 'Individual Monthly Steps',
    iconColor: 'rgb(89, 66, 189)',
    iconBg: 'rgb(242, 220, 252)',
    pcColor: 'red-600',
  },
  {
    icon: <MdGroups  />,
    ...
    percentage: '-3%',
    rank: '4th',
    title: 'Team Monthly Stpes',
    iconColor: 'rgb(173, 55, 65)',
    iconBg: 'rgb(252, 222, 224)',
    pcColor: 'green-600',
  },
  {
    icon: <AiFillFire  />,
    ...
    rank: '4th',
    title: 'Carloies Burn',
    iconColor: 'rgb(247, 183, 7)',
    iconBg: 'rgb(247, 233, 195)',
    pcColor: 'green-600',
  },
];
...
export const membersData = [
  {
    MemberName: 'Scott McCrick',
    MemberEmail: 'Scott@gmail.com',
    MemberImage:
      avatar,
    TeamName: 'Scott Research Team',
    Status: 'Active',
    StatusBg: '#8BE78B',
    Title: 'Team Captain',
    Steps: '23657',
  ...
  {
    MemberName: 'Alex Harden',
    MemberEmail: 'Alex@gmail.com',
    MemberImage:
      avatar2,
    TeamName: 'Scott Research Team',
    Status: 'Normal',
...
export const employeesData = [
  {
    ...
    Group: 'Scott Research Team',
    Title: 'Project Manager/Team Captain',
    Country: 'Blacksburg',
    ReportsTo: 'N/A',
    EmployeeImage:
      avatar,
...
export const scheduleData = [
  {
    ...
    StartTime: '2022-08-02T04:00:00.000Z',
    EndTime: '2022-08-02T05:30:00.000Z',
  ...
  },
  {
    ...
    Location: 'Space Center USA',
    StartTime: '2022-08-01T07:30:00.000Z',
    EndTime: '2022-08-01T09:00:00.000Z',
  ...
  },
  {
    ...
    Location: 'Space Center USA',
    StartTime: '2022-08-01T06:30:00.000Z',
    EndTime: '2022-08-01T08:30:00.000Z',
  ...
  },
  {
    ...
    Location: 'Himalayas',
    StartTime: '2022-08-03T05:30:00.000Z',
    EndTime: '2022-08-03T07:00:00.000Z',
    CategoryColor: '#1aaa55',
  },
  {
    Id: 8,
    ...
    Location: 'Space Center USA',
    StartTime: '2022-08-03T03:30:00.000Z',
    EndTime: '2022-08-03T04:30:00.000Z',
    CategoryColor: '#357cd2',
  },
  {
    Id: 9,
    ...
    Location: 'Space Center USA',
    StartTime: '2022-08-04T05:30:00.000Z',
    EndTime: '2022-08-04T07:30:00.000Z',
    CategoryColor: '#7fa900',
  },
  {
    Id: 10,
  ...
  },
  {
    ...
    Location: 'Sweden',
    StartTime: '2022-08-05T04:30:00.000Z',
    EndTime: '2022-08-05T06:00:00.000Z',
    CategoryColor: '#f57f17',
  },
...
export const pieChartData = [
  { x: 'Cavin', y: 18, text: '18%' },
  { x: 'Bruce', y: 8, text: '8%' },
  { x: 'Scott', y: 15, text: '15%' },
  { x: 'Mary', y: 11, text: '11%' },
  { x: 'Kevin', y: 18, text: '18%' },
  { x: 'John', y: 14, text: '14%' },
  { x: 'Poppy', y: 16, text: '16%' },
];
...
export const EditorData = () => (
  <div>
    <h3>
      Hello everyone, this is FitEx system. Have a good day and enjoy the system!
    </h3>
  </div>
);
