...
const { Users, Teams, PersonalExercise } = require('../models/Schemas.js');
...
router.post('/CreateTeam', async (req, res) => {
  ...
  try
  {
    await newTeam.save(async (err, newTeamResult) => {
      ...
      PersonalExercise.findOneAndUpdate({ User: req.body.userID }, { Team: newTeamResult.id }).exec(res.end(newTeamResult.id))
    })
  } catch (error)
  {
